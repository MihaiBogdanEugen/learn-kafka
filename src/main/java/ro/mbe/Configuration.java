...
class Configuration {
    ...
    static Properties getProducerConfig(String clientId) {
        ...
        properties.put(KafkaConfig.Producer.COMPRESSION_TYPE, "none");
        ...
        properties.put(KafkaConfig.Producer.ACKS, "1");                //  Only leader acknowledgement
    ...
    static Properties getConsumerConfig(String clientId, String groupId) {
        ...
        properties.put(KafkaConfig.Consumer.AUTO_OFFSET_RESET, "latest");
